...
async function setup() {
  noCanvas();
  const data = await d3.csv("./all_vectors_revista hd_size320_window3_sg0_mincount3_k20_c2.csv", d3.autoType);
  wordVectorMap(data);

  // hacer un recorrido por 
  // democrático -- conformación de la comunidad
  // educativo -- alfabetización digital
  // interpretación -- métodos investigativos
  // procesamiento -- métodos digitales
  // codificar -- proceso de la anotación y el análisis de textos
  // probabilidad -- procesos estadísticos
  // curioso -- interpretaciones derivadas de procesos de humanidades digitales
